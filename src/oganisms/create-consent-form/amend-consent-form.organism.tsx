...
import { DataHolderHeader } from '../../molecules/data-holder-header/data-holder-header.molecule';
import Close from 'mdi-material-ui/Close';

export type AmendConsentFormProps = {
  copy: Copy;
...
export const AmendConsentForm = (props: AmendConsentFormProps) => {
  const { copy, consent, organisation, useCase, enablePartnerMessageDiscreetMode = false, onCancel, onSubmit } = props;
  ...
  return (
    <section>
      {useCase.dataHolders && useCase.scopes && (
        <>
          <Box sx={{ mb: 3 }}>
            <DataHolderHeader consent={consent} />
          </Box>
