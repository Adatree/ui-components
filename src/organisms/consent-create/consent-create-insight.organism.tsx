    ...
    <>
      ...
      <Card sx={{ mb: 3.6 }}>
        <Typography sx={{ mb: 1.6, textAlign: { xs: 'center', sm: 'left' } }}>
          <HL>{nonAdrDataRecipient.name}</HL> needs your consent to be able to {useCase.name.toLowerCase()}.
        </Typography>
        ...
        <Typography variant="body2" sx={{ color: (theme) => lighten(theme.palette.text_main.main, 0.28) }}>
